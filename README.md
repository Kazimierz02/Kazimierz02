...
💻 **Początkujący Specjalista IT Support / Pasjonat administracji systemami**

Mam za sobą zrealizowany staż w dziale IT w firmie IQS, gdzie zdobyłem pierwsze komercyjne doświadczenie. Zajmowałem się tam m.in. bezpośrednim wsparciem technicznym użytkowników, konfiguracją sprzętu, instalacją systemów oraz rozwiązywaniem bieżących problemów (troubleshooting). 

Docelowo wiążę swoją ścieżkę zawodową z pracą na stanowisku **Helpdesk / IT Support**, gdzie mogę łączyć umiejętności techniczne z pomocą ludziom. 
